        ...
        <div class="container">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                    <!--begin::Item-->
                    <li class="nav-item">
                        <a href="{{ route('admin.dashboard') }}" class="nav-link py-4 px-3 {{ Route::is('admin.dashboard') ? ' active ' : '' }}" >Dashboard</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="{{ route('admin.billing-query.index') }}" class="{{ Route::is('admin.billing-query.index') ? ' active ' : '' }} nav-link py-4 px-3" >Billing Query</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     <li class="nav-item mr-3">
                        <a href="{{ route('admin.sale-query.index') }}" class="{{ Route::is('admin.sale-query.index') ? ' active ' : '' }} nav-link py-4 px-3" >Sale Query</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="{{route('admin.booking-activity-report.index')}}" class="{{ Route::is('admin.booking-activity-report.index') ? ' active ' : '' }} nav-link py-4 px-3" >Booking Activity Report</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     {{-- <li class="nav-item mr-3">
                        <a href="{{route('admin.site-details.index')}}" class="{{ Route::is('admin.site-details.index') ? ' active ' : '' }} nav-link py-4 px-3" >Site Details</a>
                    </li> --}}
                    <!--end::Item-->
