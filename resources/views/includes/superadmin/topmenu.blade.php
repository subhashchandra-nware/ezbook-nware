        ...
        <div class="container">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                    <!--begin::Item-->
                    <li class="nav-item">
                        <a href="{{ route('superadmin.dashboard') }}" class="nav-link py-4 px-3 {{ Route::is('superadmin.dashboard') ? ' active ' : '' }}" >Dashboard</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="{{ route('superadmin.billing-query.index') }}" class="{{ Route::is('superadmin.billing-query.index') ? ' active ' : '' }} nav-link py-4 px-3" >Billing Query</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     <li class="nav-item mr-3">
                        <a href="{{ route('superadmin.sale-query.index') }}" class="{{ Route::is('superadmin.sale-query.index') ? ' active ' : '' }} nav-link py-4 px-3" >Sale Query</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="{{route('superadmin.booking-activity-report.index')}}" class="{{ Route::is('superadmin.booking-activity-report.index') ? ' active ' : '' }} nav-link py-4 px-3" >Booking Activity Report</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     {{-- <li class="nav-item mr-3">
                        <a href="{{route('superadmin.site-details.index')}}" class="{{ Route::is('superadmin.site-details.index') ? ' active ' : '' }} nav-link py-4 px-3" >Site Details</a>
                    </li> --}}
                    <!--end::Item-->
                        ...
                        <div class="row row-paddingless">
                            ...
                            <div class="col-6">
                                <a href="{{ route('resource.resource') }}"
                                    ...
                                    <span
                                        class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Resource</span>
                                </a>
                            </div>
                            <!--end:Item-->
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="{{ route('user.index') }}"
                                    ...
                                    <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Users &
                                        Groups</span>
                                </a>
                            </div>
                            <!--end:Item-->
                            ...
                            <div class="col-6">
                                <a href="{{ route('setting.index') }}"
                                    ...
                                    <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Site
                                        Settings</span>
                                </a>
                            </div>
                            <!--end:Item-->
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2"
                        ...
                        <div class="d-flex flex-column text-right pr-sm-3">
                            <span
                                class="text-white font-weight-bold font-size-sm d-none d-sm-inline">{{ Auth::user()->name }}</span>
                        </div>
