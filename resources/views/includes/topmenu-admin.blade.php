        ...
        <div class="container">
            ...
            <div class="d-none d-lg-flex align-items-center mr-3">
                ...
                <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                    <!--begin::Item-->
                    <li class="nav-item">
                        <a href="{{ route('dashboard.index') }}" class="nav-link py-4 px-3 {{ Route::is('dashboard.index') ? ' active ' : '' }}" >Dashboard</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="#" class="{{ Route::is('book.index') ? ' active ' : '' }} nav-link py-4 px-3" >Billing Query</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     <li class="nav-item mr-3">
                        <a href="#" class="{{ Route::is('book.index') ? ' active ' : '' }} nav-link py-4 px-3" >Sale Query</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a href="#" class="{{ Route::is('book.index') ? ' active ' : '' }} nav-link py-4 px-3" >Booking Activity Report</a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                     <li class="nav-item mr-3">
                        <a href="#" class="{{ Route::is('book.index') ? ' active ' : '' }} nav-link py-4 px-3" >Site Details</a>
                    </li>
                    <!--end::Item-->
