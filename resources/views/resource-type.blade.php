                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom gutter-b">
                                ...
                                <div class="card-header border-0 py-5">
                                    ...
                                    <div class="card-toolbar">
                                        <a href="{{ url('/add-new-resource-type') }}"
                                            class="btn btn-primary font-weight-bolder font-size-sm mr-3">Add New</a>
                                        <a href="#" class="btn btn-success font-weight-bolder font-size-sm">Export
                                            to Excel</a>
                                    </div>
                                </div>
                                <!--end::Header-->
                                                    ...
                                                    @isset($data)
                                                        @foreach ($data as $res)
                                                            <tr>
                                                                ...
                                                                <td class="pl-0 py-8">
                                                                    <span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $res['Name'] }}</span>
                                                                </td>
                                                                <td>
                                                                    <span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $res['Description'] }}</span></span>
                                                                </td>
                                                                <td class="pr-0">
                                                                    <a href="{{ url('/edit-resource-type') }}/{{ $res['id'] }}"
                                                                        class="btn btn-light-success font-weight-bolder font-size-sm">View
                                                                    </a>
                                                                    <a href="#"
                                                                        onclick="deleteResourceType({{ $res['id'] }})"
                                                                        class="btn btn-light-danger font-weight-bolder font-size-sm">Delete
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
