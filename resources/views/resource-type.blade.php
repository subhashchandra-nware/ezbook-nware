...
<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled page-loading">
          ...
          <div class="d-flex flex-column-fluid">
            ...
            @if ($message = Session::get('success'))
              ...
              <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 py-5">
                  ...
                  <div class="card-toolbar">
                    ...
                    <a href="#" class="btn btn-success font-weight-bolder font-size-sm mr-3">Resource Type</a>
              ...
              <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 py-5">
                  <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark mb-4">Resource Type</span>
                  ...
                  <div class="card-toolbar">
                    <a href="{{ url('/add-new-resource-type') }}" class="btn btn-primary font-weight-bolder font-size-sm mr-3">Add New</a>
                      ...
                      <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        @foreach($data as $res)
                          <tr>
                            ...
                            <td>
                              <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $res['Description'] }}</span></span>
                            </td>
                            <td class="pr-0">
                              <a href="{{ url('/edit-resource-type')}}/{{ $res['id'] }}" class="btn btn-light-success font-weight-bolder font-size-sm">View </a>
                              <a href="#" onclick="deleteResourceType({{ $res['id'] }})" class="btn btn-light-danger font-weight-bolder font-size-sm">Delete </a>
                            </td>
                          </tr>
                          @endforeach
                          @endisset
  ...
  Swal.fire({
  title: 'Do you want to delete the resource type?',
  ...
  denyButtonText: `Delete`,
    ...
    var data = { "id" : id}
      $.ajax({
        url : "{{ url('/api/delete-resource-type') }}",
        data : data,
        type:'post',
