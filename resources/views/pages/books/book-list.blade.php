@extends('layouts.app')
@section('pageTitle', 'Books List :: EzBook')
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
										...
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">Find</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
											...
											<div class="row row-paddingless">
												...
												<div class="col-6">
													<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
														...
														<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Resource</span>
												...
												<div class="col-6">
													<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
														...
														<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Users & Groups</span>
												...
												<div class="col-6">
													<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
														...
														<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Site Settings</span>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<ul class="menu-nav ">
								...
								<li class="menu-section">
									<h4 class="menu-text">Choose A Resource</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">

										<span class="menu-text"> Resource Type1</span>
										...
										<ul class="menu-subnav">
											<li class="menu-item " aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text"> <i class="far fa-circle"></i> Resource 1 </span>
												</span>
											</li>
											<li class="menu-item " aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text"><i class="far fa-circle"></i> Resource 2</span>
												</span>
											</li>
								...
								<li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text"> Resource Type2</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
								...
								<li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text"> Resource Type3</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
								...
								<li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text"> Resource Type4</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
