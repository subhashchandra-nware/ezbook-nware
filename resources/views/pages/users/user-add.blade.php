...
@section('pageTitle', 'Add User :: EzBook')

@section('content')
    <x-layouts.page-form heading="User Add">
        {{-- <x-layouts.message /> --}}
        <x-forms.form class="form" method="post" action="{{ route('user.store') }}">
            <x-forms.input value="{{ session('siteId') }}" name="siteId" type="hidden" />
            ...
            <div class="pb-5">
                ...
                <div class="row" id="general">
                    <div class="col-xl-12">
                        ...
                        <x-forms.input value="" design="1" type="password" name="Password" label="Logon Password"
                ...
                <div class="row" id="permissions">
                    <div class="col-xl-12">
                        ...
                        <x-forms.checkbox checked="{{ $user->ManageFacilities ?? '' }}" design="1"
                            name="ManageFacilities" value="1" label="Manage Facilities"
                            desc="This option allows the user to:
                            <ul>
                        ...
                        <x-forms.checkbox checked="{{ $user->ManageSysSettings ?? '' }}" design="1"
                            name="ManageSysSettings" value="1" label="Manage Sysytem Setting"
                ...
                <div class="row" id="group-member">
                    <div class="col-xl-12">
                        ...
                        {{-- @dd($groups) --}}
                        <x-forms.select class="multiple-select2" multiple="multiple" design="1" name="GroupID[]"
