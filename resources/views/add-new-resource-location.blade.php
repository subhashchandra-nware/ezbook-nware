                                        ...
                                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                            <div class="col-xl-12">
                                                ...
                                                <form class="form" id="" method="post"
                                                    action="{{ url('add-new-resource-location') }}">
                                                    @csrf
                                                    <div class="pb-5">
                                                        <h3 class="mb-10 font-weight-bold text-dark pb-5">Add Resource
                                                            Location</h3>
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            ...
                                                                            name="Name" type="text"
                                                                            value="" />
                                                                        <span class="form-text text-muted">Enter the
                                                                            name of your in this list box.</span>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        ...
                                                                        <span class="form-text text-muted">Enter a
                                                                            descriptive sentence or two about the
                                                                            here.</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Address1</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            name="Address1" type="text"
                                                                            value="" />
                                                                        <span class="form-text text-muted">Enter
                                                                            Address1 </span>
                                                                        <span class="text-danger">
                                                                            @error('Address1')
                                                                                {{ $message }}
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Address2</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            ...
                                                                            name="City" type="text"
                                                                            value="" />
                                                                        <span class="form-text text-muted">Enter City
                                                                        </span>
                                                                        <span class="text-danger">
                                                                            @error('City')
                                                                                {{ $message }}
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">State/Province</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            name="State" type="text"
                                                                            value="" />
                                                                        <span class="form-text text-muted">Enter State
                                                                        </span>
                                                                        <span class="text-danger">
                                                                            @error('State')
                                                                                {{ $message }}
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Postal
                                                                        Code</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input
                                                                            class="form-control form-control-lg form-control-solid"
                                                                            ...
                                                                            value="" />
                                                                        <span class="form-text text-muted">Enter Postal
                                                                            Code </span>
                                                                        <span class="text-danger">
                                                                            @error('PostalCode')
                                                                                {{ $message }}
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Country</label>
                                                                    <div class="col-lg-9 col-xl-9">
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">Rucir Canada
                                Ltd.</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Nav-->
