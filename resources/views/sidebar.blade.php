        ...
        <div class="d-flex align-items-center mt-5">
          <div class="d-flex flex-column">
            ...
            <div class="navi mt-2">
              ...
              <a href="{{ route('password.reset') }}" class="btn btn-sm btn-light-danger font-weight-bolder py-2 px-5">Reset Password</a>
              @php
          ...
          <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">Account settings and more <span class="label label-light-danger label-inline font-weight-bold">update</span>
                </div>
              </div>
            </div>
          </a>
