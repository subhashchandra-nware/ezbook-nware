                            ...
                            <div class="card card-custom gutter-b">
                                ...
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label font-weight-bolder text-dark mb-4">Resource
                                            Location</span>
                                    ...
                                    <div class="card-toolbar">
                                        <a href="{{ url('/add-new-resource-location') }}"
                                                    ...
                                                    @isset($data)
                                                        @foreach ($data as $res)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $res['Address1'] }}</span></span>
                                                                </td>
                                                                <td class="pr-0">
                                                                    <a href="{{ url('/edit-resource-location') }}/{{ $res['id'] }}"
                                                                        class="btn btn-light-success font-weight-bolder font-size-sm">View
                                                                    </a>
                                                                    <a href="#"
                                                                        onclick="deleteResourceLocation({{ $res['id'] }})"
